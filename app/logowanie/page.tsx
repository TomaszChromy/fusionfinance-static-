        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-[#71717a]">
              Witaj ponownie w FusionFinance
            </p>
          </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-[#0c0d10] text-[#52525b]">lub</span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full py-3 bg-white/[0.05] border border-white/10 text-[#f4f4f5] rounded-xl hover:bg-white/[0.08] transition-colors flex items-center justify-center gap-2"
          >
